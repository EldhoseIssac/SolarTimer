...
;lcd.c,238 :: 		val = (val >> 3);
	...
	MOVF       R0+1, 0
	MOVWF      loadEnDayHrMin_val_L0+1
;lcd.c,239 :: 		dday =  val & 0x1F;
	MOVLW      31
	ANDWF      R0+0, 0
	MOVWF      FARG_Binary2BCD_a+0
;lcd.c,240 :: 		dis =   Binary2BCD(dday);
	MOVLW      0
	MOVWF      FARG_Binary2BCD_a+1
	CALL       _Binary2BCD+0
	MOVF       R0+0, 0
...
;lcd.c,241 :: 		lcdrow2[indx++] = BCD2UpperCh(dis);
	MOVF       loadEnDayHrMin_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	...
	MOVWF      INDF+0
	INCF       loadEnDayHrMin_indx_L0+0, 1
;lcd.c,242 :: 		lcdrow2[indx++] = BCD2LowerCh(dis);
	MOVF       loadEnDayHrMin_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnDayHrMin+0
...
L__loadEnDayHrMin51:
	...
	MOVF       R0+1, 0
	MOVWF      loadEnDayHrMin_val_L0+1
;lcd.c,245 :: 		dday =  val & 0x3F;
	MOVLW      63
	ANDWF      R0+0, 0
	MOVWF      FARG_Binary2BCD_a+0
;lcd.c,246 :: 		dis =   Binary2BCD(dday);
	MOVLW      0
	MOVWF      FARG_Binary2BCD_a+1
	CALL       _Binary2BCD+0
	MOVF       R0+0, 0
	...
	MOVF       R0+1, 0
	MOVWF      loadEnDayHrMin_dis_L0+1
;lcd.c,247 :: 		lcdrow2[indx++] = BCD2UpperCh(dis);
	MOVF       loadEnDayHrMin_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnDayHrMin+0
	MOVF       R0+0, 0
	...
	MOVWF      INDF+0
	INCF       loadEnDayHrMin_indx_L0+0, 1
;lcd.c,248 :: 		lcdrow2[indx++] = BCD2LowerCh(dis);
	MOVF       loadEnDayHrMin_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnDayHrMin+0
	MOVF       loadEnDayHrMin_dis_L0+0, 0
	...
	MOVWF      INDF+0
	INCF       loadEnDayHrMin_indx_L0+0, 1
;lcd.c,249 :: 		lcdrow2[indx] = '\0';
	MOVF       loadEnDayHrMin_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FSR
	CLRF       INDF+0
;lcd.c,250 :: 		Lcd_Out(2,1, lcdrow2);
	MOVLW      2
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      1
	MOVWF      FARG_Lcd_Out_column+0
...
;lcd.c,252 :: 		void loadEnHeighLow(unsigned int heigh,unsigned int low,const unsigned short shouldUseDecimal)
;lcd.c,255 :: 		unsigned int discrr= Binary2BCD(low);
...
;lcd.c,256 :: 		unsigned short indx = 0;
	CLRF       loadEnHeighLow_indx_L0+0
;lcd.c,257 :: 		if (heigh>0) {
...
;lcd.c,264 :: 		disVolt = Binary2BCD(heigh);
	MOVF       R0+0, 0
	MOVWF      FARG_Binary2BCD_a+0
	MOVF       R0+1, 0
	MOVWF      FARG_Binary2BCD_a+1
...
;lcd.c,265 :: 		lcdrow2[indx++] = BCD2HignerCh(disVolt);
	MOVF       loadEnHeighLow_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	...
	MOVWF      INDF+0
	INCF       loadEnHeighLow_indx_L0+0, 1
;lcd.c,266 :: 		lcdrow2[indx++] = BCD2UpperCh(disVolt);
	MOVF       loadEnHeighLow_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnHeighLow+0
...
;lcd.c,270 :: 		}
L_loadEnHeighLow25:
;lcd.c,271 :: 		lcdrow2[indx++] = BCD2LowerCh(disVolt);
	MOVF       loadEnHeighLow_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnHeighLow+0
	MOVF       loadEnHeighLow_disVolt_L0+0, 0
...
;lcd.c,274 :: 		lcdrow2[indx++] = ' ';
	...
	MOVWF      INDF+0
	INCF       loadEnHeighLow_indx_L0+0, 1
;lcd.c,275 :: 		lcdrow2[indx++] = BCD2HignerCh(discrr);
	MOVF       loadEnHeighLow_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnHeighLow+0
	...
	MOVWF      INDF+0
	INCF       loadEnHeighLow_indx_L0+0, 1
;lcd.c,276 :: 		lcdrow2[indx++] = BCD2UpperCh(discrr);
	MOVF       loadEnHeighLow_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnHeighLow+0
	MOVF       loadEnHeighLow_discrr_L0+0, 0
...
;lcd.c,280 :: 		}
L_loadEnHeighLow26:
;lcd.c,281 :: 		lcdrow2[indx++] = BCD2LowerCh(discrr);
	MOVF       loadEnHeighLow_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FLOC__loadEnHeighLow+0
	MOVF       loadEnHeighLow_discrr_L0+0, 0
	...
	MOVWF      INDF+0
	INCF       loadEnHeighLow_indx_L0+0, 1
;lcd.c,282 :: 		lcdrow2[indx] = '\0';
	MOVF       loadEnHeighLow_indx_L0+0, 0
	ADDLW      _lcdrow2+0
	MOVWF      FSR
	CLRF       INDF+0
;lcd.c,283 :: 		Lcd_Out(2,1, lcdrow2);
	MOVLW      2
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      1
	MOVWF      FARG_Lcd_Out_column+0
...
L_loadEnHeighLow24:
;lcd.c,285 :: 		Lcd_Out(2,1, codetxt_to_ramtxt("OFF   0.0  0.0"));
	MOVLW      ?lstr_5_lcd+0
	MOVWF      FARG_codetxt_to_ramtxt_ctxt+0
...
;lcd.c,289 :: 		void displayVoltageCurrent(){
;lcd.c,292 :: 		disVolt = Binary2BCD(lastReadVoltage);
...
;lcd.c,293 :: 		discrr = Binary2BCD(lastReadCurrent);
...
;lcd.c,294 :: 		lcdrow1[9] = BCD2HignerCh(disVolt);
	...
	MOVF       R0+0, 0
	MOVWF      _lcdrow1+9
;lcd.c,295 :: 		lcdrow1[10] = BCD2UpperCh(disVolt);
	MOVF       displayVoltageCurrent_disVolt_L0+0, 0
	MOVWF      FARG_BCD2UpperCh_bcd+0
	CALL       _BCD2UpperCh+0
	MOVF       R0+0, 0
	MOVWF      _lcdrow1+10
;lcd.c,296 :: 		lcdrow1[11] = BCD2LowerCh(disVolt);
	MOVF       displayVoltageCurrent_disVolt_L0+0, 0
	MOVWF      FARG_BCD2LowerCh_bcd+0
	CALL       _BCD2LowerCh+0
	MOVF       R0+0, 0
	MOVWF      _lcdrow1+11
;lcd.c,298 :: 		lcdrow2[9] = BCD2HignerCh(discrr);
	...
	MOVF       R0+0, 0
	MOVWF      _lcdrow2+9
;lcd.c,299 :: 		lcdrow2[10] = BCD2UpperCh(discrr);
	MOVF       displayVoltageCurrent_discrr_L0+0, 0
	MOVWF      FARG_BCD2UpperCh_bcd+0
	CALL       _BCD2UpperCh+0
	MOVF       R0+0, 0
	MOVWF      _lcdrow2+10
;lcd.c,300 :: 		lcdrow2[12] = BCD2LowerCh(discrr);
	MOVF       displayVoltageCurrent_discrr_L0+0, 0
	MOVWF      FARG_BCD2LowerCh_bcd+0
	CALL       _BCD2LowerCh+0
	MOVF       R0+0, 0
...
;lcd.c,303 :: 		void loadRamToDisp(){
;lcd.c,304 :: 		Lcd_Out(1, 1, lcdrow1);
	MOVLW      1
	MOVWF      FARG_Lcd_Out_row+0
	MOVLW      1
	MOVWF      FARG_Lcd_Out_column+0
